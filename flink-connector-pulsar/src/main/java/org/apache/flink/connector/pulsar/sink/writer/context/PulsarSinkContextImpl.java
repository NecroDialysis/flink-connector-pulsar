...
public class PulsarSinkContextImpl implements PulsarSinkContext {
    ...
    public PulsarSinkContextImpl(
        ...
        this.parallelInstanceId = writerInitContext.getTaskInfo().getNumberOfParallelSubtasks();
        this.numberOfParallelSubtasks = writerInitContext.getTaskInfo().getNumberOfParallelSubtasks();
